...
5. Kubernetes dashboard and RBAC.
   Note: Kubernetes Dashboard is now a legacy UI path. Prefer Headlamp for current learning and new setups. See `k8s/docs/workloads/k8s-ui-alternatives.md` and `k8s/html/k8s-ui-headlamp.html`.
...
Note: This is a legacy workflow retained for historical context. For current UI-based access, refer to `k8s/docs/workloads/k8s-ui-alternatives.md` and `k8s/labmanuals/lab32-workload-headlamp-kubernetes-ui.md`.
